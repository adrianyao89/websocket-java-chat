...
public class BeanUtils {
    ...
    public static Object cloneBean(Object bean) {
    	...
    	Object tmp = null;
        try {
        	tmp = BeanUtilsBean.getInstance().cloneBean(bean);
    ...
    public static String[] getArrayProperty(Object bean, String name) {
    	String[] tmp = null;
    	try {
			tmp = BeanUtilsBean.getInstance().getArrayProperty(bean, name);
		} catch (IllegalAccessException e) {
		} catch (InvocationTargetException e) {
		} catch (NoSuchMethodException e) {
		}
    ...
    public static String getProperty(Object bean, String name) {
    	String tmp = null;
        try {
        	tmp = BeanUtilsBean.getInstance().getProperty(bean, name);
		} catch (IllegalAccessException e) {
		} catch (InvocationTargetException e) {
		} catch (NoSuchMethodException e) {
		}
    ...
    public static String getSimpleProperty(Object bean, String name) {
    	String tmp = null;
        try {
			tmp = BeanUtilsBean.getInstance().getSimpleProperty(bean, name);
		} catch (IllegalAccessException e) {
		} catch (InvocationTargetException e) {
		} catch (NoSuchMethodException e) {
		}
